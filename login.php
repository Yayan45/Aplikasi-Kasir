			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<div class="content">
							<div class="inner">
								<h1>Restoran Rekayasa Perangkat Lunak</h1>
								<p>Aplikasi Dibuat Oleh "Nama Siswa" Kelas XII RPL </p>
								<p>	LSP-P1 SMK SATYA PRAJA 2 PETARUKAN </p>
							</div>
						</div>
						<nav>
							<ul>
              ...
              <form class="form-signin" method="POST">
               <p>SILAKAN LOGIN</p>
				...
				<!-- Footer -->
					<footer id="footer">
						<p class="copyright">@ 2023 LSP-P1 SMK SATYA PRAJA 2 PETARUKAN</p>
					</footer>
